...
package ass3a;
public class StrinOpertaionDemo {
	public static void main(String[] args) {
        ...
        System.out.println("Does str4 contain 'fun'? " + str4.contains("fun"));

        // 5. Substring Operations
        System.out.println("Substring of str4 (5 to 16): " + str4.substring(5, 16));
        ...
        String email = "shravana@example.com";
        boolean isValidEmail = email.contains("@") && email.startsWith("shravana") && email.endsWith(".com");
